...
#define OMAP3430_REV_ES3_1_1	0x34304035
...
#define is_device_type_test()	(omap_type() == OMAP2_DEVICE_TYPE_TEST)
#define is_device_type_emu()	(omap_type() == OMAP2_DEVICE_TYPE_EMU)
#define is_device_type_sec()	(omap_type() == OMAP2_DEVICE_TYPE_SEC)
#define is_device_type_gp()	(omap_type() == OMAP2_DEVICE_TYPE_GP)
#define is_device_type_bad()	(omap_type() == OMAP2_DEVICE_TYPE_BAD)
