...
#define VIDIOC_PRIVATE_FLASH_DRIVER	\
	_IOWR('V', BASE_VIDIOC_PRIVATE + 11, struct flash_driver_info)


enum flash_mode_enum {
	SET_TORCH_MODE = 0,
	SET_FLASH_MODE = 1
};
/* Structure for flash driver configuration */
struct flash_driver_info{
	enum flash_mode_enum	flash_mode;
	int			turn_on;
};

/* Structure for geting sensor configuration */
