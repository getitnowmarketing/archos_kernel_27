...
#define ISP_SBL_PCR                    (ISPSBL_REG_BASE + 0x04)
#define ISP_SBL_RSZ_RD0                        (ISPSBL_REG_BASE + 0x90)
#define ISP_SBL_RSZ1_WR0               (ISPSBL_REG_BASE + 0xA0)
#define ISP_SBL_REQ_EXP                        (ISPSBL_REG_BASE + 0xF8)
