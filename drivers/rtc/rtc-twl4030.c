			     ...
			     unsigned long arg)
{
	...
	case RTC_IRQP_CLEAR:
		return mask_rtc_irq_bit(0x3);
	case RTC_IRQP_SET_SEC:
		return mask_rtc_irq_bit(0x3);
	case RTC_IRQP_SET_MIN:
		mask_rtc_irq_bit(0x3);
		return set_rtc_irq_bit(0x1);
	case RTC_IRQP_SET_HR:
		mask_rtc_irq_bit(0x3);
		return set_rtc_irq_bit(0x2);
	case RTC_IRQP_SET_DAY:
		mask_rtc_irq_bit(0x3);
		return set_rtc_irq_bit(0x3);
	default:
		return -ENOIOCTLCMD;
	}
}
