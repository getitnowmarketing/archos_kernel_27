...
#define PUBLIC_CRYPTO_DES_CLOCK_BIT       (1<<0)
...
#ifdef SMODULE_SMC_OMAP3430_CRYPTOAPI_IMPL
/**
 * this function only map the AES register in this module.
 * it will NOT initialize the Public AES Operation
 */
void PDrvCryptoMapAESRegister(void);
#endif /* SMODULE_SMC_OMAP3430_CRYPTOAPI_IMPL */
