...
/* Samsung SpinPoint Alpha */
UNUSUAL_DEV(  0x04e8, 0x0401, 0x0002, 0x0002,
		"Samsung",
		"SpinPoint Alpha",
		US_SC_DEVICE, US_PR_DEVICE, archosg6gp_hdd_init,
		US_FL_NO_WP_DETECT | US_FL_NOT_REMOVABLE ),
#endif
...
UNUSUAL_DEV(  0x152d, 0x2329, 0x0100, 0x0200,
		"JMicron 20329",
		"USB SATA BRIDGE",
		US_SC_DEVICE, US_PR_DEVICE, archosg6_hdd_init,
		US_FL_NOT_REMOVABLE | US_FL_RETRY_SHORT_READ10), 
UNUSUAL_DEV(  0x152d, 0x2339, 0x0100, 0x0100,
		"JMicron 20339",
		"USB SATA BRIDGE",
		US_SC_DEVICE, US_PR_DEVICE, archosg6_hdd_init,
		US_FL_NOT_REMOVABLE ), 

UNUSUAL_DEV(  0x0e79, 0x1350, 0x0000, 0x9999,
		"ARCHOS USB-DISK 2.0",
		"USB FLASH BRIDGE",
		US_SC_DEVICE, US_PR_DEVICE, archos_flashdisk_init,
		US_FL_NOT_REMOVABLE ),
UNUSUAL_DEV(  0x13fe, 0x1d00, 0x0000, 0x9999,
		"ARCHOS USB-DISK-2.0",
		"USB FLASH BRIDGE",
		US_SC_DEVICE, US_PR_DEVICE, archos_flashdisk_init,
		US_FL_NOT_REMOVABLE ),		
