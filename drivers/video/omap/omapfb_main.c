...
static struct caps_table_struct color_caps[] = {
	...
	{ 1 << OMAPFB_COLOR_ARGB32,	"ARGB8888", },
	{ 1 << OMAPFB_COLOR_RGBA32,	"RGBA8888", },
};
...
static int ctrl_commit(struct omapfb_device *fbdev, enum omapfb_channel_out channel_out)
{
	if (fbdev->ctrl->commit)
		return fbdev->ctrl->commit(fbdev, channel_out);
	return 0;
}
			  ...
			  struct fb_var_screeninfo *var)
{
	...
	case 16:
		...
		return 0;
	case 32:
		plane->color_mode = OMAPFB_COLOR_ARGB32;
		return 0;
		      ...
		      struct fb_var_screeninfo *var)
{
	...
	pr_debug("set_fb_var: color_mode %i\n", plane->color_mode);
...
static int omapfb_check_var(struct fb_var_screeninfo *var, struct fb_info *fbi)
{
	...
	if (r < 0)
		goto out;
	r = ctrl_commit(fbdev, plane->info.channel_out);
