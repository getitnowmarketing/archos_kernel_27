...
struct display_driver {
	...
	int  (*set_brightness)(struct display_device *, unsigned int);
	int  (*get_brightness)(struct display_device *);
	int  (*set_gamma)(struct display_device *, unsigned int);
	int  (*get_gamma)(struct display_device *);
	int  (*set_vcom)(struct display_device *, unsigned int);
	int  (*get_vcom)(struct display_device *);
	int  (*set_backlight)(struct display_device *, unsigned int);
	int  (*get_backlight)(struct display_device *);
